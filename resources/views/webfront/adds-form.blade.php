      ...
      <div class="col-md-9 page-content">
        <div class="inner-box category-content">
          <h2 class="title-2 uppercase"><strong> <i class="icon-docs"></i> Post a Free Classified
            ...
            <div class="row">
              <div class="col-sm-12">
                <form class="form-horizontal" action="/post_free_add" method="post">
                  {{csrf_field()}}
                  <fieldset>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <input id="Adtitle" name="Adtitle" placeholder="Ad title" class="form-control input-md"  type="text">
                                ...
                                <div class="mb10">
                                 ...
                                 <div class="input-group ">
                                   ...
                                   <div class="input-group-btn">
                                     ...
                                     <button type="submit" class="btn btn-default kv-fileinput-upload"><i class="glyphicon glyphicon-upload"></i> Upload</button>
                                     <div class="btn btn-primary btn-file"> <i class="glyphicon glyphicon-folder-open"></i> &nbsp;Browse … <input id="input-upload-img1" type="file" class="file" data-preview-file-type="text"></div>
                                   </div>
                                 </div></span>
                               </div>
                               <div class="mb10">
                    ...
                    <div class="content-subheading"><i class="icon-user fa"></i> <strong>Seller
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input id="textinput-name" name="textinput-name" placeholder="Seller Name" class="form-control input-md"  type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-md-3 control-label" for="seller-email"> Seller
                          Email</label>
                          <div class="col-md-8">
                            <input id="seller-email" name="seller-email" class="form-control" placeholder="Email"  type="text">
                            <div class="checkbox">
                              <label>
                        ...
                        <div class="form-group">
                          <label class="col-md-3 control-label" for="seller-Number">Phone
                            Number</label>
                            <div class="col-md-8">
                              <input id="seller-Number" name="seller-Number" placeholder="Phone Number" class="form-control input-md"  type="text">
                            </div>
                          </div>
