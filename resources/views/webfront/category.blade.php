					...
					<div class="inner-box">
						...
						<div class="locations-list  list-filter">
							...
							<ul class="browse-list list-unstyled long-list">
								...
								<li><a href="{{URL('location/'.$location->location_name)}}"><span class="title">{{$category->category_name}}</span></a>
								</li>
								@endforeach
							</ul>
						</div>
								...
								<div class="tab-pane active">
									...
									<div class="item-list">
										...
										<div class="col-sm-2 no-padding photobox">
											<div class="add-image"> <span class="photo-count"><i class="fa fa-camera"></i> 2 </span> <a href="ads-details.html"><img class="thumbnail no-margin" src="" alt="img"></a> </div>
										</div>
...
/*--}}
{{$created_at}} </span> - <span class="item-location"><i class="fa fa-map-marker"></i> {{$add->location_name}} </span> </span> </div>
</div>
